  ...
  return (
    <section className={"monitor"}>
      ...
      <ul>
        ...
        <li><b>git init</b> - пишем в командную строку, чтобы создалось и настроилось место, куда скидываем "вещи"
          <p>((подготавливаем избушку на курьих ножках для хранения вещей))</p></li>
        <li><b>git add </b> - добавить все изменённые файлы (как в сдаче исправленного-переисправленного диплома)
          <p>((курьер, принести исправленный электрощиток в избушку на курьих ножках ))</p></li>
        <li><b>git commit -m</b> "first commit" - что за изменения произошли, комментарии для следующих разработчиков
          <p>((подписываем коробки с вещами Яги))</p></li>
        <li><b>git remote add origin git@github.com:GooseUchonuj/first_learn_frontend.git</b> - где хранятся данные, куда
                вести вещи для проекта ((вези курьер коробки по адресу РФ, Мухосранский лес, Болото Петра, д 0))
        </li>
        <li><b>git push -u origin master</b> ((привези коробки Яге, перечисли, что привезли))</li>
      </ul>
